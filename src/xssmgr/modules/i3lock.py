	...
	match args[0]:
		case 'start':
			if s.inner_pid is None:
				...
				s.reader = threading.Thread(target=i3lock_reader, args=(xssmgr.module_spec, outer.stdout, s.inner_pid,))
				s.reader.start()
